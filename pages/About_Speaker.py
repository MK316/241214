...
st.markdown("1. **Independent Digital Competency (독립적인 디지털 역량)**")
st.markdown("2. **Content-empowered Digital Literacy (교과목 기반 디지털 리터러시 교육)**")
st.markdown("3. **Self-sufficient Teaching Tools (자립적 디지털 교육 도구 활용)**")
