...
def main():
    ...
    with tabs[4]:
        ...
        st.image(img_url, width = 300, caption="It would've been wise to start coding back when I could actually see the screen without squinting... (to myself)", use_column_width=True)
